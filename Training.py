...
storeResults('DecisionTree', acc_train_tree, acc_test_tree)
# Random Forest model
...
storeResults('RandomForest', acc_train_forest, acc_test_forest)
...
print('Autoencoder: Accuracy on training Data: {:.3f}' .format(acc_train_auto))
...
for model in ML_Model:
    pickle.dump(xgb, open(f"{model}.pickle.dat", "wb"))
